...
// path to graperank conf file is var/lib/brainstorm/customers/<customer_name>/preferences/graperank.conf
const CONFIG_FILES = {
...
function getConfig() {
  try {
    ...
    return {
      ...
      OBSERVER_PUBKEY: CUSTOMER_PUBKEY,
...
async function main() {
  try {
    ...
    console.log(`OBSERVER_PUBKEY: ${config.OBSERVER_PUBKEY}`);
    ...
    const ratingsFile = path.join(TEMP_DIR, CUSTOMER_NAME, 'ratings.json');
